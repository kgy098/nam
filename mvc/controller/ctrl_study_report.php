...
case 'STUDY_REPORT_CREATE':
    ...
    if(!$member) jres(false, 'member not found');
    
    $ok = insert_study_report($mb_id, $subject, $title, $content, $report_date);
...
case 'STUDY_REPORT_FILE_UPLOAD':
    ...
    // 업로드 디렉토리 설정
    $upload_dir = G5_DATA_PATH.'/file/' . '/study_report';
