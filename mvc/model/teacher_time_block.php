...
// 특정 날짜/시간대의 BREAK 존재 여부 확인
function select_teacher_break_one($mb_id, $target_date, $start_time, $end_time)
{
  $sql = "
        select *
        from cn_teacher_time_block
        where mb_id = '{$mb_id}'
...
function select_teacher_time_block_by_teacher_date($mb_id, $target_date)
{
