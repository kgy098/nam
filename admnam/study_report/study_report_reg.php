  ...
  <div class="tbl_frm01 tbl_wrap local_sch04">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><label for="class_id">반</label></th>
          <td>
            <select name="class_id" id="class_id" class="frm_input" style="width:200px;">
        ...
        <tr>
          <th scope="row"><label for="mb_id">학생이름</label></th>
          <td>
            <select name="mb_id" id="mb_id" class="frm_input" style="width:200px;">
