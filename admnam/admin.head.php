...
<link rel="stylesheet" href="<?= G5_NAM_ADM_URL ?>/css/admin_darkgold.css">
...
<header id="hd">
  ...
  <div id="hd_top">
    ...
    <div id="logo">
      <a href="<?= correct_goto_url(G5_NAM_ADM_URL); ?>">
    ...
    <div id="tnb">
      <ul>
        ...
        <li class="tnb_li"><a href="<?= G5_NAM_ADM_URL ?>/service.php" class="tnb_service">부가서비스</a></li> -->
        <li class="tnb_li"><button type="button" class="tnb_mb_btn">관리자<span class="./img/btn_gnb.png">메뉴열기</span></button>
          <ul class="tnb_mb_area">
            <li><a href="<?= G5_NAM_ADM_URL ?>/member_form.php?w=u&amp;mb_id=<?= $member['mb_id'] ?>">관리자정보</a></li>
